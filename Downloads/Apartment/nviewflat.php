...
<tr>
    <td style="font-weight:bold">Flat Occupancy Status</td>
      <td>:</td>
      <td rowspan="2"><?php if($row["flatstatus"]=='yes'){?><a href="tenant_view.php" ><button style="border-radius:10px;background-color:#4CAF50;color: white;padding:10px 15px;margin-left:2% ;border: none;" name="submit" value="Submit">VIEW TENANT
</button></a><?php }else 
{echo $row["flatstatus"];}?></td>
    </tr>
