...
echo "<form action='uview_pay.php' method='POST'><button>view payments</button></form><br><br>";

echo "<center><form action='pay_insert.php' method='POST'><table>";
  ...
  echo"<button name='submit1' value='Add' type='submit'>Add</button></form>";
}
