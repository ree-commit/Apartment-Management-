...
<?php
	...
	echo "$selected_val"
	."<center><form action='pay_update.php' method='POST'><table>";
	echo"<tr><th>Door no: </th><td><input type=text id='door' value=". $_POST['door'] ."></td></tr>";
	echo"<tr><th>flat owner's name:</th><td><input type=text id='name' value=". $_POST['name'] ."></td></tr>";
	echo"<tr><th>month:</th><td><input type=text id='month' value=". $_POST['month'] ."></td></tr>";
	echo"<tr><th>Mode of payment:</th><td><input type=text id='paymode' value=". $_POST['paymode'] ."></td></tr>";
	echo"<tr><th>cheques/transaction/reciept no:  </th><td><input type=text id='chq_trac_no' value=". $_POST['chq_trac_no'] ."></td></tr>";
	echo"<tr><th>date of payment: </th><td><input type=text id='paydate' value=". $_POST['paydate'] ."></td></tr>";
	echo"<tr><th>Reciept no: </th><td><input type=text id='issued_receipt' value=". $_POST['issued_receipt'] ."></td></tr>";
	echo"<tr><th>Amount: </th><td><input type=text id='amount' value=". $_POST['amount'] ."></td></tr></table><br>";
	echo"<button name='submit' value='update' type='submit'>update</button></center>";
?>
<br><br><center><br><br>
<div id="div1" style="margin-left:50px;float:left;height:400px;width:500px;">
<form action='Regis.php'><button class="button1">Create</button></form><br><br>
<form action='udv.php' ><button class="button1" style="align:center">Update</button></form><br><br>
<form action='login.php'><button class="button1"style="align:center">Delete</button></form><br><br>
</div>
