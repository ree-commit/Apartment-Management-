...
<h3 style="text-align:center;font-size:35px;color:white;text-shadow: 5px 5px 10px black, 5px 5px 30px rgb(163, 53, 52), 5px 5px 10px rgb(163, 53, 52);">
  ...
  <form method="post" action="Uhomedata.php" class="container" enctype="multipart/form-data">
  ...
  <label for="file"><b>Photo ID Upload</b></label><br>
	...
	<label for="text"><b>Communication Address</b></label><br>
    <input type="text" placeholder="Enter Communication Address" name="Commadd" ><br>
...
<form action='Regis.php'> <button >logout</button></form>
</body>
</html>