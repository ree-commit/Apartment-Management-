...
<form action='insertl1.php' ><button class="button1" style="align:center">Create</button></form><br><br>
<form action=''><button class="button1"style="align:center">Update</button></form><br><br>
<form action='viewletter.php'><button class="button1"style="align:center">View</button></form><br><br>
<form action='deleteletter1.php'><button class="button1"style="align:center">Delete</button></form><br><br>
