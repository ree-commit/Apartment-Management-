...
<form action='pay_create.php'><button class="button1">Create</button></form><br><br>
<form action='udv.php' ><button class="button1" style="align:center">Update/Delete/View</button></form><br><br>
...
<form action='Regular_pay.php'><button class="button1"style="align:center;">Monthly Maintenance Charges</button></form><br><br>
</div>
<div id="div2" style="margin-left:500px;height:500px;width:500px;">

<form action='tdues.php'><button class="button1"style="align:center;">DUES/Deposits/Bank Balance/Investment</button></form><br><br>

<form action='#'><button class="button1"style="align:center;display:none;">AMC, Insurances Expences</button></form><br><br>
<form action='#'><button class="button1"style="align:center;display:none;">Balance Sheet</button></form><br><br>
<form action='employee_salary.php'><button class="button1"style="align:center">Employee Salary</button></form><br><br>
<form action='Regular_pay.php'><button class="button1"style="align:center"2>Regular Payments(EBB,Tel.,Diesel,Office Expenses,Stationery,Inspection,Taxes)</button></form>
<br>
</div>
<br><form action='login.php'><button class="button1"style="align:center">Log out</button></form><br><br>
